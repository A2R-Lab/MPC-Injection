...
LOG_DIR="logs/quadruped_domain_rand_mpc_dr_bound/"

# Sweep dimensions
NUM_ENVS_SWEEP=(256)
PERCENTAGES=(25)
SEEDS=(100 200 300 400 600 700 800 900 1000 1100)
...
echo "Starting quadruped domain-randomization bounding-data sweep"
echo "============================================"
...
echo ""
echo "=============================================="
echo "All domain-randomization bounding-data sweep runs completed!"
echo "=============================================="
