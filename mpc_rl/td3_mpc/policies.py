...
"""
NOTE: This file is derived from SBX's implementation of TD3. We are modifying it to be able to
...
class TD3_MPCPolicy(BaseJaxPolicy):
    ...
    def _predict(self, observation: np.ndarray, deterministic: bool = True) -> np.ndarray:  # type: ignore[override]
        ...
        return TD3_MPCPolicy.select_action(self.actor_state, observation)